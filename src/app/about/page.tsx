        ...
        <div id="contact" className="scroll-mt-24">
          <div className="bg-slate-800 dark:bg-[#1a1d24] rounded-xl p-6 sm:p-10 lg:p-14 text-center pb-8 sm:pb-12 pt-10 sm:pt-14 text-white relative overflow-hidden shadow-xl border border-gray-800">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 relative z-10">
              <a href="mailto:zakariamujur6@gmail.com" className="px-6 py-3 sm:px-8 sm:py-3.5 bg-white text-slate-800 font-bold rounded-2xl hover:bg-gray-100 transition-colors shadow-sm flex items-center gap-2 text-sm sm:text-base">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 sm:px-8 sm:py-3.5 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-2xl transition-colors shadow-sm flex items-center gap-2 text-sm sm:text-base"
              >
