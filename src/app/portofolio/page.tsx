...
export default async function PortofolioPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--bg-primary)] transition-colors duration-300">
      ...
      <article className="max-w-[1000px] mx-auto px-6 py-12 md:py-20 animate-fade-in-up">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-extrabold text-slate-800  mb-6">Galeri Portofolio & Proyek</h1>
          <p className="text-slate-500 dark:text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Eksplorasi kumpulan karya terbaik kami. Dari aplikasi marketplace hingga landing page responsif—selengkapnya ada di sini.
          </p>
        </div>
