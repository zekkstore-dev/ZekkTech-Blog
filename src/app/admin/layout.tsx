    ...
    <div className="admin-wrapper min-h-screen bg-gray-50 transition-colors duration-300">
      ...
      <div className="admin-nav max-w-7xl mx-auto px-6 py-6 border-b border-gray-200 transition-colors duration-300">
        <nav className="flex items-center gap-6 text-sm font-medium">
          <Link href="/admin" className="admin-nav-link text-gray-900 border-b-2 border-gray-900 pb-2">Artikel</Link>
          <Link href="/admin/subscribers" className="admin-nav-link-inactive text-gray-500 hover:text-gray-900 pb-2">Subscribers</Link>
          <Link href="/admin/comments" className="admin-nav-link-inactive text-gray-500 hover:text-gray-900 pb-2">Komentar</Link>
          <Link href="/admin/about" className="admin-nav-link-inactive text-gray-500 hover:text-gray-900 pb-2">Tentang Saya</Link>
        </nav>
      </div>
