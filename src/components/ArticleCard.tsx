...
export default function ArticleCard({
  ...
  return (
    <Link href={`/post/${slug}`} className="group block">
      <article className="article-card relative bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-gray-200/60 hover:-translate-y-1">
        ...
        <div className="relative w-full aspect-video overflow-hidden bg-gray-50">
          {coverUrl ? (
            ...
            <div className="card-placeholder w-full h-full bg-gradient-to-br from-blue-50 via-indigo-50 to-sky-50 flex items-center justify-center">
